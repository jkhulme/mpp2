...
matplotlib is a graphing library for Python.  The graph visualisation is built on top of matplotlib.
...
wxPython is the \ac{GUI} library.  The \ac{GUI} and the animation visualisation are built on top of wxPython.
...
simplexmlrpcserver has been used to enable communication between instances of the program.
...
\subsection{misc}
uuid, re, platform, os, time, threading, subprocess, copy, random, numpy, itertools, collections, math, pickle, sys, inspect
