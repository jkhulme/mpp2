...
\tdi{Should I cite Lamport clocks.}
...
\tdi{Talk about reordering history}
...
In all the evaluations of the project users have commented on the difficulty of using parts of the tool.  Action has been taken to make it easier to use.  Many of the changes have been guided by Shneiderman, Norman \& Nielson's guidelines~\cite{shgold}\cite{normsev}\cite{neilten}.  Specifics are detailed below.
...
\subsection{Feedback}
Norman and Shneiderman~\cite{shgold}\cite{normsev} both call for feedback to be given to the user so that the user can be sure that an action has been accomplished.  This feedback can come in a number of different forms and was in place in some parts of the project already.
