...
\item The users found the task to be easy to complete.
\item Users found the new session wizard much easier to use, still didn't know about selecting multiple files.  Added in help text since.
...
\item Had to be told about right clicking
\item Struggled when selecting text or circle annotations.
\end{itemize}
